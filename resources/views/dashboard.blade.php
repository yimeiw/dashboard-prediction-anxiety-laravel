                    ...
                    <div class="flex flex-row justify-between gap-x-4 gap-y-2">
                        ...
                        <div class="w-1/2 p-6">
                            <div class="mb-8">
                                ...
                                <input type="text" name="age" id="age" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <input type="text" name="caffeineInTake" id="caffeineInTake" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <input type="text" name="heartRate" id="heartRate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>

                            <div class="mb-8">
                                <label for="heartRateVariability" class="block text-gray-700 text-sm font-bold mb-2">What is your HRV value (ms)?</label>
                                <input type="text" name="heartRateVariability" id="heartRateVariability" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>
                        </div>
                        ...
                        <div class="w-1/2 p-6">
                            ...
                            <div class="mb-8">
                                ...
                                <input type="text" name="therapySession" id="therapySession" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>
                            ...
                            <div class="mb-8">
                                <label for="gadScale" class="block text-gray-700 text-sm font-bold mb-2">Input your GAD score (scale: 1–21).</label>
